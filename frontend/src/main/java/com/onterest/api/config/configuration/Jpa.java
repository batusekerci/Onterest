package com.onterest.api.config.configuration;

import com.onterest.api.config.QuickstartWebApplicationInitializer;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.onterest.api")
public class Jpa {
	...
	public Map<String, ?> jpaPropertiesMap() {
		...
		bean.put("hibernate.connection.characterEncoding","utf-8");
		bean.put("hibernate.enable_lazy_load_no_trans", true);
		bean.put("hibernate.show_sql", false);
		return bean;
	}
